...
<section class="landing-page-section">
  ...
  <div class="faq-container">
    ...
    <!-- <FaqItem faq= {faq}/> it will pass the choosen question object; if the variable we are using is the same name as a prop, we can use the shorthand, whis is below: -->
  ...
  <div class="additional-info mt-m">
    ...
    <p class="mt-m">Any othe questions?</p>
    <a href="https://x.com/KIZO_ES">
    <p>
      Hit me up on twitter  <img src={twitterIcon} alt="" class="twitter-icon">
    </p></a>
  </div>
</section>
