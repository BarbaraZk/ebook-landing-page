<script>
  import authorPic from "$assets/BarbImg.jpeg"
</script>
...
<p class="mb-xs">Niklas Fischer is a seasoned expatriate with over seven years of
...
to a new culture, making him an expert in the field of relocation.</p>
<p>Niklas’ practical advice is rooted in real-life experience, having
...
the lifestyle he once dreamed of.</p>
    </div>
    <img src={authorPic} alt="Author Barbara Zelek"/>
  </div>
